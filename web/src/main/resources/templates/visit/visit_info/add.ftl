                    ...
                    <div class="layui-input-block">
                        <select name="custId" lay-filter="customerSelect">
                            ...
                            <#list tbCustomerList as tbCustomer>
                                <option value="${tbCustomer.id}">${tbCustomer.customerName}</option>
                            </#list>
...
<script type="text/javascript" src="${request.contextPath}/scripts/visit/visit_info/add.js?_=${randomNum}"></script>
</body>
